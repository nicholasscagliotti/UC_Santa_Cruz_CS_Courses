...
public class List{
	...
	public boolean isEmpty(){						//Checks to see if the list is empty. True if it's empty, false if it's not.
	...
	public boolean equals(Object o){                                         //Checks to see if List and L are the same sequence of integers.
		boolean flag = true;                                    //Returns true if they match, false if they don't.
		Node a  = this.front;
		Node b  = ((List)o).front;

		if(this.length == ((List)o).length){
			while(flag && a != null){
				flag = (a.data == b.data);
				a = a.next;
				b = b.next;
	...
	public int index(){							//Returns the current index
		return index;
	}

	public Object front(){							//Returns the value of the element in the front of the array
		if(this.isEmpty()){
	...
	public Object back(){							//Returns the value of the element in the back of the array
		if(this.isEmpty()){
	...
	public Object get(){					//Returns the value of the element which the cursor is on
		if(this.isEmpty()){
	...
	public void clear(){							//Clears the List, making it an empty list
		front = back = cursor = null;
		length = 0;
		index = -1;
	}

	public void moveFront(){						//Places the cursor under the front element
		if (length() > 0){
            cursor = front;
            index = 0;
        }
	...
	public void moveBack(){						//Places the cursor under the back element
		if(this.isEmpty()){
	...
	public void movePrev(){						//Moves the cursor towards the front of of the list.
	...
	public void moveNext(){						//Moves the cursor towards the back of the list.
	...
	public void prepend(Object data){						//Inserts new element ahead of the current front element 
	...
	public void append(Object data){                                          //Inserts new element behind the current back element
		Node n = new Node(data);
	...
	public void insertBefore(Object data){                                    //Inserts a new element before the current cursor
		Node n = new Node(data);
	...
	public void insertAfter(Object data){                                    //Inserts a new element after the current cursor
		Node n = new Node(data);
